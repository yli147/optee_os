...
DEFINES
{
	...
	DEFINE(THREAD_ECALL_ARGS_SIZE, sizeof(struct thread_ecall_args));
	DEFINE(THREAD_ECALL_ARGS_A0, offsetof(struct thread_ecall_args, a0));
	DEFINE(THREAD_ECALL_ARGS_A1, offsetof(struct thread_ecall_args, a1));
	DEFINE(THREAD_ECALL_ARGS_A2, offsetof(struct thread_ecall_args, a2));
	DEFINE(THREAD_ECALL_ARGS_A3, offsetof(struct thread_ecall_args, a3));
	DEFINE(THREAD_ECALL_ARGS_A4, offsetof(struct thread_ecall_args, a4));
	DEFINE(THREAD_ECALL_ARGS_A5, offsetof(struct thread_ecall_args, a5));
	DEFINE(THREAD_ECALL_ARGS_A6, offsetof(struct thread_ecall_args, a6));
	DEFINE(THREAD_ECALL_ARGS_A7, offsetof(struct thread_ecall_args, a7));
